# ==============================================================================
# cfrrbs_insilico.R – UI and Server logic for RRBS benchmarking tab
...
cfrrbsinsilicoTabUI <- function(id, label = "cfRRBS in-silico") {
  ns <- NS(id)
  tabPanel(
    title = label, 

    #fluidPage(
    h3("Benchmarking plots: cfRRBS in-silico", style = "font-weight: bold;"),
    ...
    tags$div(class = "toc-container",
             ...
             tags$ul(class = "toc-list",
                     tags$li(tags$a(href = "#boxplots_cfrrbsinsilico", "Boxplots of the predictions for each tumoral fraction")),
                     tags$li(tags$a(href = "#nrmse_cfrrbsinsilico", "Performance (NRMSE)")),
                     tags$li(tags$a(href = "#heatmap_cfrrbsinsilico", "Heatmap of expected tumoral fraction vs deconvolution tools")),
                     tags$li(tags$a(href = "#aucroc_cfrrbsinsilico", "AUC-ROC at different tumoral fractions")),
                     tags$li(tags$a(href = "#tools-rmse_cfrrbsinsilico", "Tools RMSE")),
                     tags$li(tags$a(href = "#final_cfrrbsinsilico", "Final ranking of the tools")),
                     tags$li(tags$a(href = "#lod_cfrrbsinsilico", "Limit of detection"))
             )
    ),
    tags$hr(), br(),
    ...
    ############################################################################
    # Boxplots section
    tags$div(id = "boxplots_cfrrbsinsilico",
    ...
    sidebarLayout(
      ...
      mainPanel(width = 9,
                ...
                downloadButton(ns("download_cfrrbsinsilico_df"), "Download cfRRBS in-silico"),
    ...
    ############################################################################
    # NRMSE section
    tags$div(id = "nrmse_cfrrbsinsilico", 
    ...
    ############################################################################
    # Heatmap section
    tags$div(id = "heatmap_cfrrbsinsilico", 
    ...
    tags$div(id = "aucroc_cfrrbsinsilico", 
    ...
    tags$div(id = "tools-rmse_cfrrbsinsilico", 
             h4("Tools RMSE")),
    ...
    tags$div(id = "final_cfrrbsinsilico", 
    ...
    ############################################################################
    # LoD section
    tags$div(id = "lod_cfrrbsinsilico", 
...
cfrrbsinsilicoTabServer <- function(id) {
moduleServer(id, function(input, output, session) {

  ## 1. Filter dataset
  bench <- subset(tot_bench, 
                  seq_method == "cfrrbs" & mixture_type == "in_silico")
  ...
  output$download_cfrrbsinsilico_df <- downloadHandler(
    filename = function() {
      paste0("cfrrbs_insilico", "_", Sys.Date(), ".csv", sep = "")
    },
