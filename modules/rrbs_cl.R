# ==============================================================================
# rrbs_cl.R – UI and Server logic for RRBS benchmarking tab
  ...
  tabPanel(
    ...
    tags$div(class = "toc-container",
             ...
             tags$ul(class = "toc-list",
                     tags$li(tags$a(href = "#boxplots_rrbscl", "Boxplots of the predictions for each tumoral fraction")),
                     ...
                     tags$li(tags$a(href = "#final_rrbscl", "Final ranking of the tools"))
                     )
    ),
    tags$hr(), br(),
