...
This guide shows how to launch the **Shiny DNAmBenchmarking** app with [Singularity/Apptainer](https://sylabs.io/singularity/), commonly used on HPC systems. It uses the Docker image `sofvdvel/rshiny-dnambenchmarking:v1` and converts it to a local `.sif`.
...
```
This produces: `rshiny-dnambenchmarking_v1.sif`
