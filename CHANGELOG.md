...
- Default dataset and ability to load custom CSV files.
- Documentation and usage instructions (see [README file](README.md) for details).

<a href="https://pokemondb.net/pokedex/jellicent">
  <img src="https://img.pokemondb.net/sprites/home/normal/jellicent-f.png"
       alt="Jellicent"
       width="100">
</a>